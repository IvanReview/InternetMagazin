...
<body>
<nav class="navbar navbar-inverse navbar-fixed-top" style="background-color: #2f1e2e">
    <div class="container">
        <div class="navbar-header">
            <a class="navbar-brand" href="/"><img style="width: 30px" src="/image/лого.png"></a>
        </div>
        <div id="navbar" class="collapse navbar-collapse">
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                @else
                    <li class="nav-item dropdown">
                        <a href="{{route('person.order.index')}}">Мои заказы</a>
                    </li>
                @endif
                <li class="nav-item dropdown">
